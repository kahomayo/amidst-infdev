...
public enum InfdevSymbolicNames {
    ;

    public static final String CLASS_CHUNK_GENERATOR = "ChunkGenerator";
    public static final String CONSTRUCTOR_CHUNK_GENERATOR = "<init>";
    public static final String METHOD_CHUNK_GENERATOR_GENERATE = "generate";
